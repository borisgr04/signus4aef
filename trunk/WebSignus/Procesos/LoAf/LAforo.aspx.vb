Imports System.Data
Partial Class Procesos_LoAf_LAforo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim dta As DataTable = p.GetAforo(cldec, ag, pg, HdTAG.Value)

        Me.fnTotalizar = "javascript:TotalizarAforo(" & dta.Rows.Count & "," & redondear.ToString & ");"
    ...
    Protected Sub BtnGuardar_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        Dim Tip_Decla As String = "01" ' Inicial
        Dim TD As String = "I"
        Dim sw As Boolean
        If Dec_FDCO <> "" Then
            MsgResult.Text = objCd.Insert(Dec_Cod, dec_cdec, Me.Nit.Text, Me.DV.Text.Trim, AGravable.Text, PGravable.Text, Dec_Cor, DEC_TRET, DEC_CSAN, DEC_TSAN, dec_tot, DEC_PRS, DEC_PIM, DEC_PTOT, Tip_Decla, Me.Agente.Text, Dec_FDCO, Dec_Fven, TD, aLp, "LOAF")
        Else
            sw = True
            MsgResult.Text = "No Hay FODE"
        End If
        ...
        If (objCd.lErrorG = True) Or (sw = True) Then
            ...
            'Me.ModalPopup.Show()
        Else
            Me.MsgResult.Text = "Se realizó la Operación Satisfactoriamente" + "<br>Liquidación Oficial de Aforo N° [LOAF] :" + Dec_Cod
