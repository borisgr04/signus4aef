<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GesSoportePago.aspx.vb" Inherits="SoportesPagos_Agentes_GesSoportePago" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    ...
    <asp:GridView ID="grdPagos_Sop" runat="server" AutoGenerateColumns="False" DataSourceID="ObjPagosSop" DataKeyNames="PAG_NDOC">
        ...
        <asp:ObjectDataSource ID="ObjPagosSop" runat="server" SelectMethod="GetAll" TypeName="BLL.Pagos_SopBLL">
            <SelectParameters>
                <asp:ControlParameter ControlID="HiddenField1" Name="NIT" PropertyName="Value" Type="String" />
            </SelectParameters>
