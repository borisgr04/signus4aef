...
Partial Class Consultas_ConSaldoFavor
    ...
    Private Sub ImpDEC()
        ...
        If GridView1.SelectedValue <> "" Then
            Dec_cod = GridView1.SelectedValue
            Dec_Tdoc = GridView1.SelectedRow.Cells(1).Text()
            'Public Dec_cdec As String
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Ver"
                ImpDEC()
                Me.MsgResult.Text = "Seleccionando: Código [" + GridView1.SelectedValue + "]"
    ...
    Protected Sub Periodo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Periodo.SelectedIndexChanged
