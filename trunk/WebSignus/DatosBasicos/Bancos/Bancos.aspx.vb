Imports System.Data
Partial Class DatosBasicos_Bancos_Bancos
    Inherits PaginaComun
    Dim Obj As Bancos1 = New Bancos1
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("BAN_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("BAN_NOM").ToString
                    Me.Cboest.SelectedValue = tb.Rows(0)("BAN_EST").ToString
                    Me.HdPk1cod.Value = tb.Rows(0)("BAN_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.Cboest.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1cod.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.Cboest.SelectedValue)
        End Select
