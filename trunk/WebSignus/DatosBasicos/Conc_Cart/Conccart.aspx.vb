Imports System.Data
Partial Class DatosBasicos_Conc_Cart_Conccart
    Inherits PaginaComun
    Dim Obj As Conc_Cart = New Conc_Cart
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("CCAR_COD").ToString
                    Me.txtavcoNew.Text = tb.Rows(0)("CCAR_AVCO").ToString
                    Me.txtnomNew.Text = tb.Rows(0)("CCAR_NOM").ToString
                    Me.CboTico.SelectedValue = tb.Rows(0)("CCAR_TICO").ToString
                    Me.txtcdecNew.Text = tb.Rows(0)("CCAR_CDEC").ToString
                    Me.HdPk1.Value = tb.Rows(0)("CCAR_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.txtavcoNew.Text, Me.txtnomNew.Text, Me.CboTico.SelectedValue, Me.txtcdecNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.TxtCodNew.Text, Me.txtavcoNew.Text, Me.txtnomNew.Text, Me.CboTico.SelectedValue, Me.txtcdecNew.Text)
        End Select
