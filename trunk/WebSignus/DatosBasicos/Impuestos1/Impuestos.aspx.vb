Imports System.Data
Partial Class DatosBasicos_Impuestos1_Impuestos
    Inherits PaginaComun
    Dim Obj As Impuestos1 = New Impuestos1
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("IMP_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("IMP_NOM").ToString
                    Me.TxtObsNew.Text = tb.Rows(0)("IMP_OBS").ToString
                    Me.TxtNorNew.Text = tb.Rows(0)("IMP_NOR").ToString
                    Me.CmbClase.SelectedValue = tb.Rows(0)("IMP_CLA").ToString
                    Me.CboUniNew.SelectedValue = tb.Rows(0)("IMP_UNI").ToString
                    Me.HdPk1.Value = tb.Rows(0)("IMP_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub Habilitar(ByVal b As Boolean)
        ...
        Me.TxtObsNew.Enabled = b
        Me.TxtNorNew.Enabled = b
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.TxtObsNew.Text, Me.TxtNorNew.Text, Me.CmbClase.SelectedValue, Me.CboUniNew.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.TxtObsNew.Text, Me.TxtNorNew.Text, Me.CmbClase.SelectedValue, Me.CboUniNew.SelectedValue)
        End Select
