Imports System.Data
Partial Class DatosBasicos_Municipios1_Municipios
    Inherits PaginaComun
    Dim Obj As Municipios = New Municipios
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("MUN_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("MUN_NOM").ToString
                    Me.Cbdep.SelectedValue = tb.Rows(0)("MUN_DPCO").ToString
                    Me.HdPk1cod.Value = tb.Rows(0)("MUN_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.Cbdep.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1cod.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.Cbdep.SelectedValue)
        End Select
