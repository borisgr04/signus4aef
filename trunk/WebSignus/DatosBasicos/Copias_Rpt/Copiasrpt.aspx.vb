Imports System.Data
Partial Class DatosBasicos_Copias_Rpt_Copiarpt
    Inherits PaginaComun
    Dim Obj As Copias_Rpt = New Copias_Rpt
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("COP_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("COP_NOM").ToString
                    Me.HdPk1cod.Value = tb.Rows(0)("COP_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1cod.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text)
        End Select
