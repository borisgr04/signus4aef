Imports System.Data
Partial Class DatosBasicos_Tipo_Proceso_Tipoproceso
    Inherits PaginaComun
    Dim Obj As tipo_proceso = New tipo_proceso
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodiNew.Text = tb.Rows(0)("TPRO_CODI").ToString
                    Me.TxtNombNew.Text = tb.Rows(0)("TPRO_NOMB").ToString
                    Me.HdPk1.Value = tb.Rows(0)("TPRO_CODI").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodiNew.Text, Me.TxtNombNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.TxtCodiNew.Text, Me.TxtNombNew.Text)
        End Select
