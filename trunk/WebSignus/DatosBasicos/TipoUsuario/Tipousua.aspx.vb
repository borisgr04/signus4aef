Imports System.Data
Partial Class DatosBasicos_TipoUsuario_Tipousua
    Inherits PaginaComun
    Dim Obj As tipousua = New tipousua
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("TUS_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("TUS_NOM").ToString
                    Me.HdPk1.Value = tb.Rows(0)("TUS_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
