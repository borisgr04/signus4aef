Imports System.Data
Partial Class DatosBasicos_Departamentos1_Departamentos
    Inherits PaginaComun
    Dim Obj As Departamentos = New Departamentos
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("COD_DEPTO").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("NOM_DEPTO").ToString
                    Me.txtabervNew.Text = tb.Rows(0)("ABREV_DISFON").ToString
                    Me.HdPk1.Value = tb.Rows(0)("COD_DEPTO").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.txtabervNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.txtabervNew.Text)
        End Select
