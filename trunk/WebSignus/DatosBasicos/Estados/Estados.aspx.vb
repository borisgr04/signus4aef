Imports System.Data
Partial Class DatosBasicos_Estados_Estados
    Inherits PaginaComun
    Dim Obj As Estados = New Estados
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("EST_COD").ToString
                    Me.TxtdesNew.Text = tb.Rows(0)("EST_DES").ToString
                    Me.HdPk1.Value = tb.Rows(0)("EST_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtdesNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.TxtCodNew.Text, Me.TxtdesNew.Text)
        End Select
