Imports System.Data
Partial Class DatosBasicos_Tipo_Cuenta_Tipocuenta
    Inherits PaginaComun
    Dim Obj As Tipo_Cuenta = New Tipo_Cuenta
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodiNew.Text = tb.Rows(0)("TCTA_CODI").ToString
                    Me.TxtNombNew.Text = tb.Rows(0)("TCTA_NOMB").ToString
                    Me.HdPk1.Value = tb.Rows(0)("TCTA_CODI").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
