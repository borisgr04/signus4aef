...
<asp:Label ID="LBTITULO" runat="server" CssClass="Titulo">Diligenciar Liquidación Oficial</asp:Label>&nbsp;
    <div class="DecHeader">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"   >
            <ContentTemplate>
&nbsp;<asp:Label id="MsgResult" runat="server" Width="90%" Height="30px" __designer:wfdid="w9"></asp:Label>&nbsp; <BR /><TABLE width=600 __designer:dtid="844424930131979"><TBODY><TR __designer:dtid="844424930131980"><TD style="HEIGHT: 13px" class="TDNegroFila" __designer:dtid="844424930131981"><asp:Label id="Label10" runat="server" Font-Bold="True" __designer:dtid="844424930131982" __designer:wfdid="w10" Text="AGENTE RECAUDADOR"></asp:Label>&nbsp;&nbsp; <asp:Button style="DISPLAY: none" id="button" onclick="button_Click" runat="server" __designer:dtid="3096246218653697" __designer:wfdid="w198"></asp:Button></TD></TR><TR __designer:dtid="844424930131984"><TD __designer:dtid="844424930131985"><TABLE width="100%" __designer:dtid="844424930131986"><TBODY><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);" __designer:dtid="844424930131987"><TD style="WIDTH: 25px; HEIGHT: 15px" __designer:dtid="844424930131988"><asp:Label id="Label45" runat="server" Width="115px" Font-Bold="True" __designer:dtid="844424930131989" CssClass="TitDecl" __designer:wfdid="w12" Text="IDENTIFICACIÓN"></asp:Label></TD><TD style="WIDTH: 51px; HEIGHT: 15px" __designer:dtid="844424930131990">&nbsp;<asp:Label id="Label2" runat="server" Font-Bold="True" __designer:dtid="844424930131991" CssClass="TitDecl" __designer:wfdid="w13" Text="DV"></asp:Label> </TD><TD style="WIDTH: 24px; HEIGHT: 15px"></TD><TD style="WIDTH: 131px; HEIGHT: 15px" __designer:dtid="844424930131992"><asp:Label id="Label11" runat="server" Font-Bold="True" __designer:dtid="844424930131993" CssClass="TitDecl" __designer:wfdid="w14" Text="RAZON SOCIAL"></asp:Label></TD><TD style="WIDTH: 253px; HEIGHT: 15px" __designer:dtid="844424930131994"></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);" __designer:dtid="844424930131995"><TD style="HEIGHT: 19px; TEXT-ALIGN: right" __designer:dtid="844424930131996"><asp:TextBox id="Nit" runat="server" __designer:dtid="844424930131997" __designer:wfdid="w15" Enabled="False"></asp:TextBox>&nbsp; </TD><TD style="WIDTH: 51px; HEIGHT: 19px" __designer:dtid="844424930131998">-<asp:TextBox id="Dv" runat="server" Width="17px" __designer:dtid="844424930131999" __designer:wfdid="w16" Enabled="False"></asp:TextBox>&nbsp;</TD><TD style="WIDTH: 24px; HEIGHT: 19px"><asp:Button accessKey="B" id="BtnBuscDP" onclick="BtnBuscar_Click" runat="server" __designer:wfdid="w2" Text="..." UseSubmitBehavior="False" ToolTip="Buscar Agente Recaudador"></asp:Button></TD><TD style="HEIGHT: 19px" colSpan=2 __designer:dtid="844424930132000"><asp:TextBox id="Agente" runat="server" Width="332px" __designer:dtid="844424930132001" __designer:wfdid="w17" Enabled="False"></asp:TextBox></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="HEIGHT: 19px" colSpan=5>&nbsp;</TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_On(this);" __designer:dtid="844424930132002"><TD style="HEIGHT: 19px" colSpan=5 __designer:dtid="844424930132003"><asp:Label id="Label1" runat="server" Width="261px" Font-Bold="True" __designer:dtid="844424930132004" CssClass="TitDecl" __designer:wfdid="w18" Text="SELECCIONE LA CLASE DE DECLARACION"></asp:Label> <asp:DropDownList id="CbCdec" runat="server" __designer:dtid="844424930132007" __designer:wfdid="w19" OnSelectedIndexChanged="CbCdec_SelectedIndexChanged" DataValueField="CLD_COD" DataTextField="CLD_NOM" DataSourceID="ObjCDec" AutoPostBack="True"></asp:DropDownList></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><TABLE width=600><TBODY><TR onmouseover="Resaltar_On(this);" class="TbDecl" onmouseout="Resaltar_Off(this);"><TD colSpan=6><asp:Label id="LbI" runat="server" Font-Bold="True" __designer:wfdid="w20" Text="PERIODO DE DECLARACION Y TIPO DE DECLARACIÓN"></asp:Label>&nbsp;</TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="WIDTH: 7px"></TD><TD style="WIDTH: 100px"><asp:Label id="Label14" runat="server" CssClass="TitDecl" __designer:wfdid="w21" Text="AÑO GRAVABLE"></asp:Label></TD><TD style="WIDTH: 100px"><asp:DropDownList id="CboVigencia" runat="server" __designer:wfdid="w22" DataValueField="cal_vig" DataTextField="cal_vig" DataSourceID="ObjCalVigencias" AutoPostBack="True">
                    </asp:DropDownList> <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" __designer:wfdid="w2" ValidationGroup="Dil" ControlToValidate="CbCdec">*</asp:RequiredFieldValidator></TD><TD style="WIDTH: 8px"></TD><TD style="WIDTH: 100px"><asp:Label id="Label13" runat="server" Width="133px" CssClass="TitDecl" __designer:wfdid="w23" Text="PERIODO GRAVABLE"></asp:Label></TD><TD style="WIDTH: 100px"><asp:DropDownList id="Periodo" runat="server" __designer:wfdid="w24" DataValueField="cal_per" DataTextField="cal_des" DataSourceID="ObjCal">
                    </asp:DropDownList> <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" __designer:wfdid="w4" ValidationGroup="Dil" ControlToValidate="Periodo">*</asp:RequiredFieldValidator></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="WIDTH: 7px"></TD><TD colSpan=2><asp:Label id="Label5" runat="server" Font-Bold="True" __designer:wfdid="w25" Text="TIPO DE LIQUIDACIÓN"></asp:Label></TD><TD style="WIDTH: 8px"></TD><TD style="WIDTH: 100px"></TD><TD style="WIDTH: 100px"></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="WIDTH: 7px"></TD><TD vAlign=top colSpan=2>&nbsp;<asp:DropDownList id="CboTDOC" runat="server" __designer:wfdid="w436" OnSelectedIndexChanged="CboTDOC_SelectedIndexChanged" AutoPostBack="True"><asp:ListItem Value="LOAF">Liquidaci&#243;n Oficial de Aforo</asp:ListItem>
<asp:ListItem Value="LORV">Liquidaci&#243;n Oficial de Revisi&#243;n</asp:ListItem>
<asp:ListItem Value="LOCO">Liquidaci&#243;n Oficial de Correcci&#243;n</asp:ListItem>
</asp:DropDownList></TD><TD style="WIDTH: 8px"></TD><TD style="WIDTH: 100px"><asp:RadioButtonList id="ROptTD" runat="server" __designer:wfdid="w26" Enabled="False" DataValueField="TDEC_COD" DataTextField="TDEC_NOM" DataSourceID="ObjTDec"></asp:RadioButtonList></TD><TD style="WIDTH: 100px" vAlign=top></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="WIDTH: 7px"></TD><TD colSpan=2></TD><TD style="WIDTH: 8px"></TD><TD style="WIDTH: 100px"></TD><TD style="WIDTH: 100px" vAlign=top></TD></TR></TBODY></TABLE><TABLE width="100%" border=0 __designer:dtid="3659174697238541"><TBODY><TR __designer:dtid="3659174697238542"><TD onmouseover="Resaltar_On(this);" class="TbDecl" onmouseout="Resaltar_Off(this);" colSpan=16 __designer:dtid="3659174697238543">&nbsp;<asp:Label id="Label29" runat="server" __designer:dtid="3659174697238544" __designer:wfdid="w29" Text="SIGNATARIOS"></asp:Label></TD></TR><TR __designer:dtid="3659174697238545"><TD style="HEIGHT: 78px; TEXT-ALIGN: left" __designer:dtid="3659174697238546"><asp:FormView id="FormView1" runat="server" __designer:wfdid="w161" DataSourceID="ObjSign"><ItemTemplate>
