Imports System.Data
Partial Class DatosBasicos_Vigencias_Vigencias
    Inherits PaginaComun
    Dim Obj As Vigencias = New Vigencias
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodiNew.Text = tb.Rows(0)("VIG_COD").ToString
                    Me.CboEst.SelectedValue = tb.Rows(0)("VIG_EST").ToString
                    Me.txtFFin.Text = tb.Rows(0)("VIG_FFIN").ToString
                    Me.txtfini.Text = tb.Rows(0)("VIG_FINI").ToString
                    Me.HdPk1CODI.Value = tb.Rows(0)("VIG_COD").ToString
                    Habilitar(True)
                End If
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodiNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1CODI.Value, Me.CboEst.SelectedValue)
        End Select
    ...
    Protected Sub Nuevo()
        ...
        Me.Habilitar(True)
        Limpiar()
        Me.TxtCodiNew.Text = CDec(OVig.GetActivaD()) + 1
