...
Public Class Util
    ...
    Public Shared Function ImageByte(ByRef oFile As FileUpload) As Byte()
        ...
        If oFile.HasFile Then
            ...
            image = reader.ReadBytes(oFile.PostedFile.ContentLength)
    ...
    Public Shared Function CrearHeader(n As Integer) As String

        Dim Header As String = ""
        Dim alf As String = " ABCDEFGHIJKLMNOPQRSTUVWXYZ"
        Dim alfB As String = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"

        Dim i As Integer = 0
        Dim salir As Boolean = False

        For Each c1 As Char In alf
            For Each c2 As Char In alfB
                Console.WriteLine(i.ToString + "-" + Trim(c1 + c2))
                Header += IIf(String.IsNullOrEmpty(Header), "", ",") + Trim(c1 + c2)
                If (i = (n - 1)) Then
                    salir = True
                    Exit For
                End If
