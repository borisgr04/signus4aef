Imports System.Data
Partial Class Procesos_LoRv_Dil
    ...
    Protected Sub BtnDil_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDil.Click
        ...
        If tp = "LOAF" Then
            ...
            Dim Ruta As String = "/Procesos/LoRv/LRv.aspx?data=" + HttpUtility.UrlEncode(querystringSeguro.ToString())
        ...
        Else
            ...
            Else
                ...
                Me.MsgBox(Me.MsgResult, False)
                'Response.Redirect(Rt)
                Response.Redirect("/Procesos/Resa/Resa.aspx?data=" + HttpUtility.UrlEncode(querystringSeguro.ToString()))
            End If
        End If
