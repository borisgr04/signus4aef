Imports System.Data
Partial Class Procesos_ReSa_Resa
    ...
    Protected Sub BtnGuardar_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        Dim sw As Boolean
        If Dec_FDCO <> "" Then
            MsgResult.Text = objCd.Insert(Dec_Cod, dec_cdec, Me.Nit.Text, Me.DV.Text.Trim, AGravable.Text, PGravable.Text, Dec_Cor, DEC_TRET, DEC_CSAN, DEC_TSAN, dec_tot, DEC_PRS, DEC_PIM, DEC_PTOT, Tip_Decla, Me.Agente.Text, Dec_FDCO, Dec_Fven, TD, aLp, "LORV")
        Else
            sw = True
