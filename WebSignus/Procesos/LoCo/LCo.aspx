...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" Runat="Server">
    ...
    <div class="demoarea">
        <asp:Label ID="Tit" runat="server" CssClass="Titulo" Text="Liquidación de Corrección"
            Width="286px"></asp:Label><br />
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
<TABLE style="WIDTH: 500px" width="100%" __designer:dtid="1125994396123201"><TBODY><TR onmouseover="Resaltar_On(this);" class="DivNegroFila" onmouseout="Resaltar_Off(this);" __designer:dtid="1125994396123202"><TD style="HEIGHT: 13px" class="TDNegroFila" __designer:dtid="1125994396123203"><asp:Label id="MsgResult" runat="server" __designer:wfdid="w16"></asp:Label><BR /><asp:Label id="Label10" runat="server" Font-Bold="True" Text="II. INFORMACIÓN DEL RESPONSABLE O AGENTE RETENEDOR" __designer:dtid="1125994396123204" __designer:wfdid="w49"></asp:Label></TD></TR><TR __designer:dtid="1125994396123205"><TD style="WIDTH: 800px; HEIGHT: 162px" __designer:dtid="1125994396123206"><TABLE width="100%" __designer:dtid="1125994396123207"><TBODY><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);" __designer:dtid="1125994396123215"><TD style="WIDTH: 130px; HEIGHT: 15px" __designer:dtid="1125994396123216">&nbsp;<asp:Label id="Label45" runat="server" Width="94px" Font-Bold="True" Text="IDENTIFICACIÓN" __designer:dtid="1125994396123218" __designer:wfdid="w54" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 91px; HEIGHT: 15px" __designer:dtid="1125994396123219">&nbsp;<asp:Label id="Label5" runat="server" Width="23px" Font-Bold="True" Text="DV" __designer:dtid="1125994396123220" __designer:wfdid="w55" CssClass="TitDecl"></asp:Label></TD><TD style="HEIGHT: 15px" colSpan=2><asp:Label id="Label11" runat="server" Width="187px" Font-Bold="True" Text="RAZON SOCIAL" __designer:dtid="1125994396123211" __designer:wfdid="w2" CssClass="TitDecl"></asp:Label></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);" __designer:dtid="1125994396123227"><TD style="WIDTH: 130px; HEIGHT: 19px; TEXT-ALIGN: left" __designer:dtid="1125994396123228"><asp:Label id="Nit" runat="server" __designer:dtid="1125994396123229" __designer:wfdid="w60" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 91px; HEIGHT: 19px" __designer:dtid="1125994396123230">- <asp:Label id="DV" runat="server" Width="23px" __designer:dtid="1125994396123231" __designer:wfdid="w61" CssClass="TitDecl"></asp:Label></TD><TD style="HEIGHT: 19px" colSpan=2><asp:Label id="Agente" runat="server" __designer:dtid="1125994396123214" __designer:wfdid="w3" CssClass="TitDecl"></asp:Label></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="HEIGHT: 19px" colSpan=4><asp:Label id="Label2" runat="server" Font-Bold="True" Text="CLASE DE DECLARACIÓN" __designer:dtid="1125994396123171" __designer:wfdid="w74" CssClass="TitDecl"></asp:Label></TD></TR><TR onmouseover="Resaltar_On(this);" onmouseout="Resaltar_Off(this);"><TD style="HEIGHT: 19px; TEXT-ALIGN: left" colSpan=4><asp:DropDownList id="CmbClDec" runat="server" Width="401px" __designer:dtid="1407374883553335" __designer:wfdid="w13" DataSourceID="ObjClaseDec" DataTextField="cld_nom" DataValueField="cld_cod" Enabled="False">
                            </asp:DropDownList></TD></TR></TBODY></TABLE><TABLE width="100%" __designer:dtid="1125994396123163"><TBODY><TR><TD style="WIDTH: 6px" __designer:dtid="1125994396123168"></TD><TD style="WIDTH: 100px" class="TDNegroTexto" __designer:dtid="1125994396123170"><asp:Label id="Label14" runat="server" Width="97px" Font-Bold="True" Text="AÑO GRAVABLE" __designer:dtid="1125994396123171" __designer:wfdid="w68" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 97px; TEXT-ALIGN: left" __designer:dtid="1125994396123172">&nbsp;<asp:Label id="AGravable" runat="server" Width="61px" __designer:dtid="1125994396123173" __designer:wfdid="w69" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 8px" __designer:dtid="1125994396123174"></TD><TD style="WIDTH: 100px" class="TDNegroTexto" __designer:dtid="1125994396123176"><asp:Label id="LbPGravable" runat="server" Width="133px" Font-Bold="True" Text="PERIODO GRAVABLE" __designer:dtid="1125994396123177" __designer:wfdid="w71" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 100px; TEXT-ALIGN: left" __designer:dtid="1125994396123178">&nbsp;<asp:Label id="PGravable" runat="server" Width="60px" __designer:dtid="1125994396123179" __designer:wfdid="w72" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"></TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"></TD></TR><TR><TD style="WIDTH: 6px"></TD><TD style="TEXT-ALIGN: left" colSpan=2><asp:Label id="Label9" runat="server" Font-Bold="true" Text="N° Formulario que Corrige" __designer:dtid="1688944349544509" __designer:wfdid="w1" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 8px"></TD><TD style="WIDTH: 100px" class="TDNegroTexto"><asp:Label id="TxtDecCorrige" runat="server" Width="86px" __designer:dtid="1688944349544511" __designer:wfdid="w2" CssClass="TitDecl"></asp:Label></TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"></TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"></TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"></TD></TR></TBODY></TABLE><asp:ObjectDataSource id="ObjProc" runat="server" __designer:dtid="2251799813685254" TypeName="Procesos" SelectMethod="GetLCAritmetica" OldValuesParameterFormatString="original_{0}" __designer:wfdid="w78"><SelectParameters __designer:dtid="2251799813685255">
...
<HeaderTemplate>
<TABLE><TBODY><TR>
<TD style="WIDTH: 20px">Código</TD><TD style="WIDTH: 300px">Impuesto</TD><TD style="WIDTH: 100px">Base Gravable</TD><TD style="WIDTH: 50px">Tarifa</TD>
<TD style="WIDTH: 100px">Valor Impuesto</TD>
<TD style="WIDTH: 100px">Valor Corrección</TD>
</TR></TBODY></TABLE>
</HeaderTemplate>
