Imports System.Data
Partial Class DatosBasicos_Tipo_Agent_Tipoagent
    Inherits PaginaComun
    Dim Obj As Tipo_Agent = New Tipo_Agent
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("TAG_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("TAG_NOM").ToString
                    Me.Cboagent.SelectedValue = tb.Rows(0)("TAG_EST").ToString
                    Me.HdPk1cod.Value = tb.Rows(0)("TAG_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.Cboagent.SelectedValue)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1cod.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.Cboagent.SelectedValue)
        End Select
