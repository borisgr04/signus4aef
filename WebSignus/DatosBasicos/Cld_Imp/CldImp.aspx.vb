Imports System.Data
Partial Class DatosBasicos_Cld_Imp_CldImp
    Inherits PaginaComun
    Dim Obj As Cld_Imp = New Cld_Imp
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    ...
                    Me.txtcimpNew.Text = tb.Rows(0)("CLD_CIMP").ToString
                    Me.txtabimNew.Text = tb.Rows(0)("CLD_ABIM").ToString
                    Me.txtabvaNew.Text = tb.Rows(0)("CLD_ABVA").ToString
                    Me.HdPk1.Value = tb.Rows(0)("CLD_COD").ToString
                    Me.Hdpk2.Value = tb.Rows(0)("CLD_CIMP").ToString
                    Habilitar(True)
                    Me.ModalPopupTer.Show()
                End If
    ...
    Protected Sub Habilitar(ByVal b As Boolean)
        ...
        Me.txtcimpNew.Enabled = b
        Me.txtabimNew.Enabled = b
        Me.txtabvaNew.Enabled = b
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.txtcimpNew.Text, Me.txtabimNew.Text, Me.txtabvaNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.Hdpk2.Value, Me.TxtCodNew.Text, Me.txtcimpNew.Text, Me.txtabimNew.Text, Me.txtabvaNew.Text)
        End Select
    ...
    Protected Sub BtnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.MsgResult.Text = Obj.Delete(Me.TxtCodNew.Text, Me.txtcimpNew.Text)
        Me.MsgBox(MsgResult, Obj.lErrorG)
        FillCustomerInGrid()
    End Sub
