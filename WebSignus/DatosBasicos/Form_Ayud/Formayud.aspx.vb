Imports System.Data
Partial Class DatosBasicos_Form_Ayud_Formayud
    Inherits PaginaComun
    Dim Obj As Form_ayud = New Form_ayud
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodiNew.Text = tb.Rows(0)("FOAY_CODI").ToString
                    Me.txtnrenNew.Text = tb.Rows(0)("FOAY_NREN").ToString
                    Me.txtfdcoNew.Text = tb.Rows(0)("FOAY_FDCO").ToString
                    Me.txttituNew.Text = tb.Rows(0)("FOAY_TITU").ToString
                    Me.txtdescNew.Text = tb.Rows(0)("FOAY_DESC").ToString
                    Me.HdPk1.Value = tb.Rows(0)("FOAY_CODI").ToString
                    Habilitar(True)
                End If
    ...
    Protected Sub Habilitar(ByVal b As Boolean)
        ...
        Me.txtnrenNew.Enabled = b
        'Me.txtfdcoNew.Enabled = b
        Me.txttituNew.Enabled = b
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodiNew.Text, Me.txtnrenNew.Text, Me.txtfdcoNew.Text, Me.txttituNew.Text, Me.txtdescNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1.Value, Me.TxtCodiNew.Text, Me.txtnrenNew.Text, Me.txtfdcoNew.Text, Me.txttituNew.Text, Me.txtdescNew.Text)
        End Select
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.Oper.Value = "Nuevo"
        Me.SubT.Text = "Nuevo..."
        ...
        Me.txtfdcoNew.Text = Me.CboFode.SelectedValue
        Me.SetFocus(Me.txttituNew)

    End Sub

    Protected Sub BtnAct_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.DataBind()
    End Sub
End Class
