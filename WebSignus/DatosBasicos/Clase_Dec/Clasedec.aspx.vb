Imports System.Data
Partial Class DatosBasicos_Clase_Dec_Clasedec
    Inherits PaginaComun
    Dim Obj As Clase_Dec = New Clase_Dec
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("CLD_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("CLD_NOM").ToString
                    Me.TxtFecIni.Text = CDate(tb.Rows(0)("CLD_FIN").ToString).ToShortDateString
                    Me.TxtFecFin.Text = CDate(tb.Rows(0)("CLD_FFI").ToString).ToShortDateString
                    Me.txtconsNew.Text = tb.Rows(0)("CLD_CONS").ToString

                    Me.HdPk1cod.Value = tb.Rows(0)("CLD_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
            ...
            Case "Eliminar"
                Dim index As Integer = Convert.ToInt32(e.CommandArgument)
                Me.GridView1.SelectedIndex = index
                Me.HdPk1cod.Value = GridView1.DataKeys(index).Values(0).ToString()
                Dim tb As DataTable = Obj.GetPorCod(GridView1.SelectedValue)
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("CLD_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("CLD_NOM").ToString
    ...
    Protected Sub BtnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Me.Oper.Value
            Case "Nuevo"
                Me.MsgResult.Text = Obj.Insert(Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.TxtFecIni.Text, Me.TxtFecFin.Text, Me.txtconsNew.Text)
            Case "Editar"
                Me.MsgResult.Text = Obj.Update(Me.HdPk1cod.Value, Me.TxtCodNew.Text, Me.TxtNomNew.Text, Me.TxtFecIni.Text, Me.TxtFecFin.Text, Me.txtconsNew.Text)
        End Select
