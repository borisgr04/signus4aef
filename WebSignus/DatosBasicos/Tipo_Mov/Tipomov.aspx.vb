Imports System.Data
Partial Class DatosBasicos_Tipo_Mov_Tipomov
    Inherits PaginaComun
    Dim Obj As Tipo_Mov = New Tipo_Mov
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("TMOV_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("TMOV_NOM").ToString
                    Me.HdPk1.Value = tb.Rows(0)("TMOV_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
