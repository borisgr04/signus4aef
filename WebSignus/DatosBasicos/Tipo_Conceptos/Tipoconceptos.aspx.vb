Imports System.Data
Partial Class DatosBasicos_Tipo_Conceptos_Tipoconceptos
    Inherits PaginaComun
    Dim Obj As Tipo_Conceptos = New Tipo_Conceptos
        ...
        Select Case Me.Oper.Value
            ...
            Case "Editar"
                ...
                If tb.Rows.Count > 0 Then
                    Me.TxtCodNew.Text = tb.Rows(0)("TCON_COD").ToString
                    Me.TxtNomNew.Text = tb.Rows(0)("TCON_NOM").ToString
                    Me.HdPk1.Value = tb.Rows(0)("TCON_COD").ToString
                    Habilitar(True)
                End If
                Me.ModalPopupTer.Show()
