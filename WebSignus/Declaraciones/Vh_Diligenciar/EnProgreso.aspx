<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EnProgreso.aspx.vb" Inherits="Declaraciones_Vh_Diligenciar_EnProgreso" %>
...
<body>
   ...
   <script type="text/javascript" language="javascript">
      ...
      <asp:UpdatePanel ID="UpdTime" runat="server">
        <ContentTemplate>
            <asp:label id="lblBarraProcentaje" style="Z-INDEX: 100; LEFT: 22px; POSITION: absolute; TOP: 59px"
				runat="server" BackColor="CornflowerBlue"></asp:label>
