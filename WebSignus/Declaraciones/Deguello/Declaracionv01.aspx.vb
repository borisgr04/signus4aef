...
Partial Class Declaraciones_Deguello_Declaracionv01
    ...
    Public Function LiquidarCorreccion() As Boolean
        ...
        Dim Saldo As Decimal = 0 'Es para liquidacion por corrección
        Dim Tr As Double = 0
        Dim r As Integer = 0
        Dim j As Integer = 0
        ...
        For i As Integer = 0 To Cant - 1
            ...
            If HdTICO.Value = "S" Then
                LiqP(i).CODE_TSAN = CboTSan.SelectedValue
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Or (Me.TD = "C") Then
                    Select Case CboTSan.SelectedValue
                        Case "00"
                            Me.MsgResult.Text = "Debe Seleccionar el Tipo de Sanción de la Liquidación Privada"
                            Me.ModalPopup.Show()
        ...
        For i As Integer = 0 To Cant2 - 1
            ...
            If HdTICO.Value = "I" Then
                ...
                Me.MsgResult.Text += "<br/> Valor Intereses:" + FormatCurrency(LiqP(j).CODE_VADE.ToString)
                Me.ModalPopup.Show()
                txtR.Text = LiqP(j).CODE_VADE
                C_I = LiqP(j).CODE_VADE
                Tr += LiqP(j).CODE_VADE
