...
Partial Class Declaraciones_Deguello_Declaracionv21
    Inherits PaginaComun
    Dim NroRenglon As String = "9"
    Dim Dec_nro As String
    Dim objCd As CDeclaraciones21
    ...
    Private Function TieneExpediente() As Boolean
        Dim apg As New Expe_Apg()
        Return apg.ExistePeriodosEnExpediente(Me.PGravable.Text, Me.AGravable.Text, Me.Cla_Dec.Value, Me.Nit)
        'Return True
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.Opcion = "Degüello Ganado Mayor"
            Me.SetTitulo()
    ...
    Private Sub Cargar_datos()
        ...
        objCd = New CDeclaraciones21(Me.Cla_Dec.Value)
        ...
        If (fecha_lim < CDate(Me.HdFecDec.Value)) Then
            ...
            Else
                ...
                Me.HdVALPAG_INI.Value = objCd.Valor_Pagado(Me.dec_cor)
                Me.HdVALPAG_INI_K.Value = objCd.Valor_PagadoK(Me.dec_cor)
        ...
        Else
            Me.HdExtem.Value = "N"
            Me.MsgResult.Text = "No se calcula, ni sanción, ni interés" '+ Me.TD
            Me.LSanciones = False
        End If
    ...
    Protected Sub ReportViewer1_SubreportProcessing(ByVal sender As Object, ByVal e As SubreportProcessingEventArgs)
        ...
        Dim obj As CDeclaraciones21 = New CDeclaraciones21(Me.Cla_Dec.Value)
    ...
    Protected Sub Repeater1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If (HdTICO.Value = "S") And Me.TD = "I" Then
                ...
                If TieneExpediente() Then
                    CboTSan.SelectedValue = "02" 'Sanción por no Declarar Con Emplazamiento
                    CboTSan.Enabled = False
                End If
            ...
            TxtR.Attributes.Add("onBlur", "Resaltar_Off(this);")
            TxtR.ReadOnly = True
    ...
    Public Function Cargar_CODE(ByRef LP As LPCODE_CDEC()) As Boolean
        ...
        For i As Integer = 0 To Cant - 1
            ...
            If (LiqP(i).CODE_CODI = "02") Then
                LiqP(i).CODE_TARI = HdTari.Value
                LiqP(i).CODE_VADE = objCd.RedondearUp(LiqP(i - 1).CODE_VADE * LiqP(i).CODE_TARI)
            End If
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        'SpanAyuda
        Me.objCd = New CDeclaraciones21(Me.Cla_Dec.Value)
    ...
    Protected Sub BtnLiq_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BtnLiq.Click
        'Dim Tip_Decla As String = Me.HdDecTip.Value
        Dim lp() As LPCODE_CDEC = {}
        Me.Liquidar(lp)
    End Sub

    Public Function Liquidar(ByRef LP As LPCODE_CDEC()) As Boolean
        If Me.TD = "I" Then
            LiquidarInicial(LP)
        ElseIf Me.TD = "C" Then
            LiquidarCorreccion(LP)
        End If
        'MsgResult.Text = Me.TD
        'ModalPopup.Show()
        Return True
    End Function


    Public Function LiquidarInicial(ByRef LP As LPCODE_CDEC()) As Boolean
    ...
    Public Function LiquidarCorreccion(ByRef LP As LPCODE_CDEC()) As Boolean
                ...
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Or (Me.HdTD.Value = "C") Then
                    Select Case CboTSan.SelectedValue
                        ...
                        Case "02"
                            LiqP(i).CODE_VADE = objCd.GetSancion_Extemporaneidad(C_K, CDate(Me.HdFecDec.Value), CDate(Me.HdFecLim.Value), 1)
                        Case "03"
                            LiqP(i).CODE_VADE = objCd.RedondearUp(C_K - CDec(HdVALPAG_INI.Value)) ''100%
                        Case "08"
                            LiqP(i).CODE_VADE = objCd.RedondearUp((C_K - CDec(HdVALPAG_INI.Value)) * 0.1)
                        Case "09"
                            LiqP(i).CODE_VADE = objCd.RedondearUp((C_K - CDec(HdVALPAG_INI.Value)) * 0.2)
                        Case "10"
                            LiqP(i).CODE_VADE = objCd.RedondearUp((C_K - CDec(HdVALPAG_INI.Value)) * 0.25) '25%
                        Case Else
                            LiqP(i).CODE_VADE = 0
                    End Select
                    C_S = LiqP(i).CODE_VADE
        ...
        For i As Integer = 0 To Cant2 - 1
            ...
            If HdTICO.Value = "I" Then
                ...
                DC_K = C_K - Me.HdVALPAG_INI_K.Value
                LiqP(j).CODE_VADE = objCd.GetInteresMoraC(DC_K, CDate(Me.HdFecLim.Value), CDate(Me.HdFecDec.Value))
