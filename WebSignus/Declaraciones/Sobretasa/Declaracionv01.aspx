<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Declaracionv01.aspx.vb" Inherits="Declaraciones_SobreTasa_Declaracionv01" %>
                    ...
                    <HeaderTemplate>
                            <table class="datatable" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="center"><b>CLASE DE PRODUCTOS</b></td>
                                    <td class="center"><b>GALONES GRAVADOS</b></td>
                                    <td class="center"><b>PRECIO DE REFERENCIA POR GALON </b></td>
                                    <td class="center"><b>% DE ALCOHOL CARBUR.</b></td>
                                    <td class="center"><b>BASE GRAVABLE</b></td>   
                                    <td class="center"><b>SOBRETASA</b></td>   
                                </tr>
                                <tr id="itemPlaceholder" runat="server" />
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr>
                            <%--CoCd_Cdec, CoCd_Codi, Clase, CoCd_Impto, Galones, Precio_Ref, Porc_Alcohol, BASEGRAVABLE, Tarifa, VALORIMPUESTO,CoCd_Nomb --%>
                            
                            <td style="width: 17px; " >
                                <asp:textbox ID="NR" ReadOnly="true" runat="server" Text='<%#NRenglon()%>' CssClass="NRenglon"></asp:textbox></td>
                            <td style="width: 200px; ">
                                <asp:Label ID="lbClaseActos" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "CLASE_PRODUCTOS")%>'></asp:Label>
                            </td>
                            <td style="width: 100px; text-align:right ">
                                <asp:Label ID="lbNActos"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "GALONES")%>' ></asp:Label>
                            </td>
                            <td class="center" style="width: 100px; text-align:right ">
                                 <asp:Label ID="lbCuantia" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "PRECIO_REF", "{0:c}")%>'></asp:Label>
                            </td>
                            <td class="center" style="width: 100px; text-align:right ">
                                <asp:Label ID="lbTarifa" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "PORC_ALCOHOL", "{0:c}")%>'></asp:Label>
                            </td>
                            <td class="center" style="width: 100px; text-align:right ">
                                <asp:Label ID="lbVrImpto" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "BASEGRAVABLE", "{0:c}")%>'></asp:Label>
                            </td>   
                            <td class="center" style="width: 100px; text-align:right ">
                                <asp:Label ID="lbVrIntereses" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "VALORIMPUESTO","{0:c}")%>'></asp:Label>
                            </td>   
                        </tr>
                </ItemTemplate>
                <FooterTemplate>
