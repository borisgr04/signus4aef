...
Partial Class Declaraciones_Estampillas_Declaracionv42
                ...
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Or (Me.HdTD.Value = "C") Then
                    Select Case CboTSan.SelectedValue
                        ...
                        Case "02"
                            LiqP(i).CODE_VADE = objCd.GetSancion_Extemporaneidad(C_K, CDate(Me.HdFecDec.Value), CDate(Me.HdFecLim.Value), 1)
                        Case "03"
                            LiqP(i).CODE_VADE = C_K - CDec(HdVALPAG_INI.Value)
                        Case "08"
                            LiqP(i).CODE_VADE = (C_K - CDec(HdVALPAG_INI.Value)) * 0.1
                        Case "09"
                            LiqP(i).CODE_VADE = (C_K - CDec(HdVALPAG_INI.Value)) * 0.2
                        Case Else
                            LiqP(i).CODE_VADE = 0
                    End Select
                    C_S = LiqP(i).CODE_VADE
