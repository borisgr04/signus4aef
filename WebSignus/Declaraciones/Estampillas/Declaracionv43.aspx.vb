...
Partial Class Declaraciones_Estampillas_Declaracionv43
    Inherits PaginaComun
    Dim NroRenglon As String = "9"
    Dim Dec_nro As String
    Dim objCd As CDeclaraciones41
    ...
    Private Sub Cargar_datos()
        ...
        objCd = New CDeclaraciones41(Me.Cla_Dec.Value)
    ...
    Protected Sub ReportViewer1_SubreportProcessing(ByVal sender As Object, ByVal e As SubreportProcessingEventArgs)
        ...
        Dim obj As CDeclaraciones41 = New CDeclaraciones41(Me.Cla_Dec.Value)
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        'SpanAyuda
        Me.objCd = New CDeclaraciones41(Me.Cla_Dec.Value)
    ...
    Public Function LiquidarCorreccion() As Boolean
        ...
        For i As Integer = 0 To Cant2 - 1
            ...
            If HdTICO.Value = "F" Then
                ...
                Dim SaldoAFavor As Decimal = objCd.RedondearUp(txtR.Text)
                Me.MsgResult.Text = SaldoAFavor.ToString() + "-" + (VP_COR + C_I).ToString()
                If SaldoAFavor > (VP_COR + C_I) Then
                    Me.MsgResult.Text = "El Saldo a Favor para esta declaración, no debe exceder el valor a pagar."
                    LiqP(j).CODE_VADE = (VP_COR + C_I)
                    txtR.Text = (VP_COR + C_I)
                    Tr -= LiqP(j).CODE_VADE
                    Me.ModalPopup.Show()
                    Return False
