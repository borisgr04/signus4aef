<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Ctrl_VhMarca.ascx.vb" Inherits="CtrlUsr_Vehiculo_Ctrl_VhMarca" %>
...
<table style="width:550px;">
    ...
    <tr>
        <td>
            <asp:Label ID="lbNomMarca" runat="server" Text="Nombre de la Marca"></asp:Label>
        </td>
        <td>
            &nbsp;</td>
        <td>
    ...
    <tr>
        <td>
            <asp:TextBox ID="tbNomMarca" runat="server" Width="450px"></asp:TextBox>
        </td>
        <td>
    ...
    <tr>
        <td>
            Nombre de la Marca Anterior</td>
        <td>
            &nbsp;</td>
        <td>
            &nbsp;</td>
    ...
    <tr>
        <td>
            <asp:TextBox ID="tbNomMarcaOld" runat="server"  Width="450px" Enabled="False"></asp:TextBox>
...
<asp:View ID="vwLista" runat="server"> 
    <table style="width: 550px;">
        <tr>
            <td>
                Marca:</td>
            <td>
                <asp:TextBox ID="tbBuscaNomMarca" runat="server" Width="400px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            <td colspan="3">
                <asp:LinkButton ID="btNuevo" runat="server">Nueva Marca</asp:LinkButton>
            </td>
        </tr>
    </table>
    <asp:GridView ID="gvMarcas" runat="server" AllowPaging="True" 
                AutoGenerateColumns="False" DataKeyNames="ID_VH_MARCA" DataSourceID="odsMarcas">
                <Columns>
    ...
    <asp:ObjectDataSource ID="odsMarcas" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetPorNombre" 
        TypeName="Vh_Marca">
        <SelectParameters>
            <asp:ControlParameter ControlID="tbBuscaNomMarca" Name="NOM_MARCA" 
